/**
 * a port of the original krush game.
 * 
 * how will you reach the destination, with your limited brain power?
 */
...
int main(int argc, char *argv[])
{
	...
	// TODO: Respond to keyboard events.
	...
	// TODO: Touches the target and win.
